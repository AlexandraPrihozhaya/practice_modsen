  ...
  return (
    <SBlock>
      <Formik
        ...
        <SDiv className="form-group">
        <SLabel htmlFor="password2" className={touched.password2 && errors.password2 ? 'error' : touched.password2 && !errors.password2 ? 'valid' : ''}>Подтвердите пароль</SLabel>
          <SInput type="password" name="password2" placeholder="123456" 
                  className={touched.password2 && errors.password2 ? 'error' : touched.password2 && !errors.password2 ? 'valid' : ''}/>
